...
def top_250():
    """Pulls out movie names from the Imdb Top 250 webpage and adds them to a
...
def top250_yearcount():
    """Creates a dictionary of number of movies of a particular year in the
    Imdb Top 250.
...
def years_top250():
    """Creates a dictionary of year of the movies of the top 250 in the order
    of ranking.
    Returns  dictionary"""
...
class Movie():
    ...
    def director(self):
        """Returns the Name of Director"""
        return self.stuff.find('movie').get("director")

    def actors(self):
        """Returns the premier cast"""
